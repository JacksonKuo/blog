...
# Python Refresher
CodeAcademy has a nice sandbox to refresh on the syntax. Python 3 is behind the paywall, but Python 2 is free and essentially the same:[^1]
* python syntax
* strings
...
[^1]: [https://www.codecademy.com/enrolled/courses/learn-python](https://www.codecademy.com/enrolled/courses/learn-python)

[^2]: [https://www.datacamp.com/blog/python-2-vs-3-everything-you-need-to-know](https://www.datacamp.com/blog/python-2-vs-3-everything-you-need-to-know)

[^3]: [https://www.codecademy.com/learn/learn-python](https://www.codecademy.com/learn/learn-python)

[^4]: [https://docs.python-guide.org/writing/tests/](https://docs.python-guide.org/writing/tests/)
