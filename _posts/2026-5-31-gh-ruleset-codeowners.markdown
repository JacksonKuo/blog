...
* External contributors 
    * Would need to be put on a `ext-` team, i would think. 

#### Ruleset Construction
Assuming we're using custom properties + `Require review from Code Owners`, we would we need?

`Repositories matching a filter` + props.tktk:true
