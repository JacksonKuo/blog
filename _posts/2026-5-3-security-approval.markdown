...
# Problem Statement
When is it okay to say yes and when is it not? Often security education tends to focus on the technical skills, exploits and vulnerabilities.
...
This is a writeup on how to navigate this process, particularly the murky situations
...
#### When to Say No
* No
    - Occasionally, something is so risky and batshit dangerous, security will just say no.
...
It's up to you to determine security's preference. Devs will have their own preference, which often will be no security. Security is often on the other side of that spectrum. Ideally we work together to come up with an amicable solution.

Some devs can be very aggressive, which can add to the stress. And then from a personality perspective, I have the tendency to want to help and say Yes. This might be somewhat cultural, or maybe it's evolutionary, perhaps all my ancestors who said No got executed thousands of years ago.

There's all sorts of things devs say and do to apply pressure:
* Direct @ you in slack
...
* Asking for approval during a zoom meeting, as it's harder to decline in person
...
* Just because a executive is asking, doesn't mean they know the risk. Or even are opposed to an alternative that would address the risk. So when a dev says a higher up executive wants this, take that with a grain of salt. 
...
* Is this a nice to have? What is the pain level here that devs are struggling with? For example, are devs complaining about something that they've already been doing for months? Are they willing to wait for additional tooling to be created to address the risk before the change is approved? 
* Lastly, a manager of mine once said: it's not on security to accept risk. It's on the business to determine how much risk they're willing to accept. Any risk that needs to be accepted, is ultimately held by leadership and they choose to sign-off or not sign-off on risk
