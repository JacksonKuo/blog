...
Note to self, you shouldn't instantiate a service in the constructor. That will break the autowiring. 
...
Also explicitly using `Autowired` is now frowned upon:[^8]
